...
// 1 = TPhotoElecCompton
  ...
  Int_t nRuns = 7000;         // number of the Runs
//Histos and stuff
...
// We define the Glue and Epoxy position
  ...
  const Double_t epoxy_dz   = 0.0075;   //half width of epoxy window (0.15mm) in Oz.
...
//const Double_t apd_dz  = 0.00025;    //half-width of silicium of APD - 50 microns 
  ...
  cout<< ""<< endl;
  cout<< " Definition of APD, Si - 450 microns"<< endl;
  cout<< ""<< endl;
...
//
  ...
  source->Gen(101+i,4);
  // PMT spectrum
  if (gCs->fNpSeen) spectrum->Fill(80*(gCs->fNpSeen));
